// GitHub mark, single path, fill inherited from the parent's text color so
// hover/disabled states apply to the icon and label together.
function GithubIcon() {
  return (
...
export function ViewCodeButton({ href }: { href?: string }) {
  ...
  return (
    <a
      ...
      className={`${base} border-border text-fg-dim hover:border-accent-dim hover:text-accent focus-visible:border-accent-dim focus-visible:text-accent`}
    >
      <GithubIcon />
      View Code
    </a>
